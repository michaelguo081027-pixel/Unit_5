...
void optionClicks(){
  if(mouseX>300&&mouseX<500&&mouseY>600&&mouseY<700)mode=intro;
  else if(mouseX>100&&mouseX<250&&mouseY>200&&mouseY<300)difficulty=classic;
  else if(mouseX>325&&mouseX<475&&mouseY>200&&mouseY<300)difficulty=bonus;
  else if(mouseX>550&&mouseX<700&&mouseY>200&&mouseY<300)difficulty=insane;
}
